...
export default function Ranking() {
  ...
  const classRanking = [
    { rank: 1, name: 'Lớp 10A2', points: 48650, members: 32, avatar: '🏆' },
    { rank: 2, name: 'Lớp 9B3', points: 45200, members: 30, avatar: '🥈' },
    { rank: 3, name: 'Lớp 11C1', points: 42800, members: 28, avatar: '🥉' },
  ];

  const neighborhoodRanking = [
    { rank: 1, name: 'Phường 1 - Đà Lạt', points: 185400, members: 1240, avatar: '🏙️' },
    { rank: 2, name: 'Phường 2 - Đà Lạt', points: 172300, members: 1180, avatar: '🌆' },
    { rank: 3, name: 'Phường 3 - Đà Lạt', points: 168900, members: 1320, avatar: '🏘️' },
  ];
            ...
            >
              ...
              <div className={`p-6 text-center ${
                ...
                <div className={`w-20 h-20 mx-auto rounded-full flex items-center justify-center mb-3 ${
                  selectedBadge.unlocked
                    ? `bg-gradient-to-br ${
                        selectedBadge.color === 'orange' ? 'from-orange-400 to-orange-500' :
